...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:Buffy20!@localhost/marvel'
...
def create_database():
    root_engine = create_engine("mysql+mysqlconnector://root:Buffy20!@localhost")  # No database specified
